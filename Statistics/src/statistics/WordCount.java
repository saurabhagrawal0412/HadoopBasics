...
//    private final static IntWritable one = new IntWritable(1); // type of output value
    private LongWritable outPutValue = new LongWritable();   // type of output key
    ...
    public void map(LongWritable key, Text value, Context context
      ...
      while (itr.hasMoreElements()) {
    	  outPutValue.set((Long)itr.nextElement());
    	     // set word as each input keyword
        context.write(outPutValue, new IntWritable(1));     // create a pair <keyword, 1> 
      }
    }
  }
  ...
  public static class Reduce
    ...
    public void reduce(LongWritable key, Iterable<IntWritable> values, 
      ...
      context.write("Min", v1);
      context.write("Max", v2);
      context.write("Avg", sum/n);
      context.write("stdd", )
    }
  }
