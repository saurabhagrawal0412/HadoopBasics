	...
	public void reduce(LongWritable key, Iterable<Text> values,
			Context context) throws IOException, InterruptedException
	  {
		...
		for (Text value: values)
		{
			...
			{
				System.out.println();
				targetUrlsList=targetUrlsList+stringValue;

				continue;
			}
			sumOfRankValues=sumOfRankValues+Double.parseDouble(stringValue);
//			System.out.println("sumof rank vaues"+sumOfRankValues);
